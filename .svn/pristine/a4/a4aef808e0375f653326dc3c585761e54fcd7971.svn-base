...
NSString *const APPLICATION_NAME = @"PLAYSKOOL-Ages0to3";
...
{    
    ...
    //Playskool - Research
    [Parse setApplicationId:@"5kztLw44aLzgoAKTz1adry8I3JXjzxqaBRSWDuIw"
                  clientKey:@"kLMiQLgrxrSqHj1FSnpeGFUI14vU8WBIMoKUDKOa"];
    ...
    // NOTE: [WK] Temporarily replaced with CES version to allow for use at CES 2013
    self.viewController.startPage = @"index-ages-0to3.html";
